  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-slate-900 text-white relative overflow-hidden">
      ...
      <div className="bg-slate-800 p-8 rounded-2xl shadow-xl w-full max-w-md relative z-10 border border-slate-700/50">
        ...
        <p className="text-center text-slate-400 mb-8">Login to access your trading dashboard</p>
        ...
        <p className="mt-8 text-center text-sm text-slate-400">
          Don't have an account? <Link to="/signup" className="text-emerald-400 hover:text-emerald-300 font-bold hover:underline">Sign up</Link>
        </p>
      </div>
      <FloatingSupport />
    </div>
